...
namespace Language_sr {
  ...
  PROGMEM Language_Str WELCOME_MSG                         = MACHINE_NAME _UxGT(" ће да ради.");
  ...
  PROGMEM Language_Str MSG_MEDIA_INSERTED                  = _UxGT("SD-карта убачена");
  PROGMEM Language_Str MSG_MEDIA_REMOVED                   = _UxGT("SD-карта избачена");
  PROGMEM Language_Str MSG_MEDIA_WAITING                   = _UxGT("Убаците SD-карту");
  #if LCD_WIDTH > 21
  ...
  PROGMEM Language_Str MSG_MAIN                            = _UxGT("Основни мени");
  ...
  PROGMEM Language_Str MSG_AUTO_HOME                       = _UxGT("Паркирање");
  PROGMEM Language_Str MSG_AUTO_HOME_X                     = _UxGT("Паркирање X");
  PROGMEM Language_Str MSG_AUTO_HOME_Y                     = _UxGT("Паркирање Y");
  PROGMEM Language_Str MSG_AUTO_HOME_Z                     = _UxGT("Паркирање Z");
  PROGMEM Language_Str MSG_AUTO_Z_ALIGN                    = _UxGT("Аутоматско Z-поравнање");
  ...
  PROGMEM Language_Str MSG_MOVE_X                          = _UxGT("Померај по X");
  PROGMEM Language_Str MSG_MOVE_Y                          = _UxGT("Померај по Y");
  PROGMEM Language_Str MSG_MOVE_Z                          = _UxGT("Померај по Z");
  ...
  PROGMEM Language_Str MSG_MOVE_N_MM                       = _UxGT("Померај %sмм");
  PROGMEM Language_Str MSG_MOVE_01MM                       = _UxGT("Померај 0.1мм");
  PROGMEM Language_Str MSG_MOVE_1MM                        = _UxGT("Померај 1мм");
  PROGMEM Language_Str MSG_MOVE_10MM                       = _UxGT("Померај 10мм");
  ...
  PROGMEM Language_Str MSG_CONTROL                         = _UxGT("Подешавања");
  ...
  PROGMEM Language_Str MSG_MOTION                          = _UxGT("Померање");
  ...
  PROGMEM Language_Str MSG_INFO_SCREEN                     = _UxGT("Главни екран");
  ...
  PROGMEM Language_Str MSG_FILAMENTCHANGE                  = _UxGT("Замена филамента");
  PROGMEM Language_Str MSG_FILAMENTCHANGE_E                = _UxGT("Замена филамента *");
  ...
  PROGMEM Language_Str MSG_INFO_PRINTER_MENU               = _UxGT("Подаци штампача");
  #if LCD_WIDTH > 21
