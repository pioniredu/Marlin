...
namespace Language_sr {
  constexpr uint8_t    CHARSIZE                            = 2;
  PROGMEM Language_Str LANGUAGE                            = _UxGT("Serbian");

  PROGMEM Language_Str WELCOME_MSG                         = MACHINE_NAME _UxGT(" је спреман.");
  ...
  PROGMEM Language_Str MSG_MEDIA_ABORTING                  = _UxGT("Прекидам...");
  PROGMEM Language_Str MSG_MEDIA_INSERTED                  = _UxGT("Медиј убачен");
  PROGMEM Language_Str MSG_MEDIA_REMOVED                   = _UxGT("Медиј избачен");
  PROGMEM Language_Str MSG_MEDIA_WAITING                   = _UxGT("Чекам на медиј");
  PROGMEM Language_Str MSG_SD_INIT_FAIL                    = _UxGT("Медиј се не може покренути");
  PROGMEM Language_Str MSG_MEDIA_READ_ERROR                = _UxGT("Медиј се не може учитати");
  PROGMEM Language_Str MSG_MEDIA_USB_REMOVED               = _UxGT("USB уређај избачен");
  PROGMEM Language_Str MSG_MEDIA_USB_FAILED                = _UxGT("USB уређај се не може покренути");
  PROGMEM Language_Str MSG_KILL_SUBCALL_OVERFLOW           = _UxGT("Subcall Overflow");
  PROGMEM Language_Str MSG_LCD_ENDSTOPS                    = _UxGT("Граничници"); // Max length 8 characters
  PROGMEM Language_Str MSG_LCD_SOFT_ENDSTOPS               = _UxGT("Меки граничници");
  PROGMEM Language_Str MSG_MAIN                            = _UxGT("Почетак");
  PROGMEM Language_Str MSG_ADVANCED_SETTINGS               = _UxGT("Напредна подешавања");
  PROGMEM Language_Str MSG_CONFIGURATION                   = _UxGT("Подешавања");
  ...
  PROGMEM Language_Str MSG_DEBUG_MENU                      = _UxGT("Уклањање грешака");
  PROGMEM Language_Str MSG_PROGRESS_BAR_TEST               = _UxGT("Progress Bar Test");
  PROGMEM Language_Str MSG_AUTO_HOME                       = _UxGT("Паркирај");
  PROGMEM Language_Str MSG_AUTO_HOME_X                     = _UxGT("Паркирај X");
  PROGMEM Language_Str MSG_AUTO_HOME_Y                     = _UxGT("Паркирај Y");
  PROGMEM Language_Str MSG_AUTO_HOME_Z                     = _UxGT("Паркирај Z");
  ...
  PROGMEM Language_Str MSG_LEVEL_BED_HOMING                = _UxGT("Паркирам XYZ");
  PROGMEM Language_Str MSG_LEVEL_BED_WAITING               = _UxGT("Кликни да почнеш");
  PROGMEM Language_Str MSG_LEVEL_BED_NEXT_POINT            = _UxGT("Следећа тачка");
  PROGMEM Language_Str MSG_LEVEL_BED_DONE                  = _UxGT("Нивелисање завршено!");
  ...
  PROGMEM Language_Str MSG_SET_ORIGIN                      = _UxGT("Подеси извор");
  ...
  PROGMEM Language_Str MSG_SELECT_ORIGIN                   = _UxGT("Изабери извор");
  PROGMEM Language_Str MSG_LAST_VALUE_SP                   = _UxGT("Последња вредност ");
  #if PREHEAT_COUNT
    PROGMEM Language_Str MSG_PREHEAT_1                     = _UxGT("Загревање ") PREHEAT_1_LABEL;
    PROGMEM Language_Str MSG_PREHEAT_1_H                   = _UxGT("Загреј ") PREHEAT_1_LABEL " ~";
    PROGMEM Language_Str MSG_PREHEAT_1_END                 = _UxGT("Загреј ") PREHEAT_1_LABEL _UxGT(" врх");
    PROGMEM Language_Str MSG_PREHEAT_1_END_E               = _UxGT("Загреј ") PREHEAT_1_LABEL _UxGT(" врх ~");
    PROGMEM Language_Str MSG_PREHEAT_1_ALL                 = _UxGT("Загреј ") PREHEAT_1_LABEL _UxGT(" све");
    PROGMEM Language_Str MSG_PREHEAT_1_BEDONLY             = _UxGT("Загреј ") PREHEAT_1_LABEL _UxGT(" тацну");
    PROGMEM Language_Str MSG_PREHEAT_1_SETTINGS            = _UxGT("Подешавање ") PREHEAT_1_LABEL _UxGT(" загревања");

    PROGMEM Language_Str MSG_PREHEAT_M                     = _UxGT("Загреј $");
    PROGMEM Language_Str MSG_PREHEAT_M_H                   = _UxGT("Загреј $ ~");
    PROGMEM Language_Str MSG_PREHEAT_M_END                 = _UxGT("Загреј $ врх");
    PROGMEM Language_Str MSG_PREHEAT_M_END_E               = _UxGT("Загреј $ врх ~");
    PROGMEM Language_Str MSG_PREHEAT_M_ALL                 = _UxGT("Загреј $ све");
    PROGMEM Language_Str MSG_PREHEAT_M_BEDONLY             = _UxGT("Загреј $ тацну");
    PROGMEM Language_Str MSG_PREHEAT_M_SETTINGS            = _UxGT("Подешавање $ загревања");
  #endif
  PROGMEM Language_Str MSG_PREHEAT_CUSTOM                  = _UxGT("Призвољно загревање");
  PROGMEM Language_Str MSG_COOLDOWN                        = _UxGT("Охлади");

  PROGMEM Language_Str MSG_CUTTER_FREQUENCY                = _UxGT("Фреквенција");
  ...
  PROGMEM Language_Str MSG_SWITCH_PS_ON                    = _UxGT("Укључи напајање");
  PROGMEM Language_Str MSG_SWITCH_PS_OFF                   = _UxGT("Искључи напајање");
  PROGMEM Language_Str MSG_EXTRUDE                         = _UxGT("Extrude");
  PROGMEM Language_Str MSG_RETRACT                         = _UxGT("Retract");
  PROGMEM Language_Str MSG_MOVE_AXIS                       = _UxGT("Померај осу");
  PROGMEM Language_Str MSG_BED_LEVELING                    = _UxGT("Нивелисање тацне");
  PROGMEM Language_Str MSG_LEVEL_BED                       = _UxGT("Поравнај тацну");
  PROGMEM Language_Str MSG_LEVEL_CORNERS                   = _UxGT("Поравнај углове");
  ...
  PROGMEM Language_Str MSG_MOVING                          = _UxGT("Померам...");
  PROGMEM Language_Str MSG_FREE_XY                         = _UxGT("Ослободи XY");
  PROGMEM Language_Str MSG_MOVE_X                          = _UxGT("Померај X");
  PROGMEM Language_Str MSG_MOVE_Y                          = _UxGT("Померај Y");
  PROGMEM Language_Str MSG_MOVE_Z                          = _UxGT("Померај Z");
  ...
  PROGMEM Language_Str MSG_MOVE_N_MM                       = _UxGT("Померај %smm");
  PROGMEM Language_Str MSG_MOVE_01MM                       = _UxGT("Померај 0.1mm");
  PROGMEM Language_Str MSG_MOVE_1MM                        = _UxGT("Померај 1mm");
  PROGMEM Language_Str MSG_MOVE_10MM                       = _UxGT("Померај 10mm");
  PROGMEM Language_Str MSG_MOVE_0001IN                     = _UxGT("Померај 0.001in");
  PROGMEM Language_Str MSG_MOVE_001IN                      = _UxGT("Померај 0.01in");
  PROGMEM Language_Str MSG_MOVE_01IN                       = _UxGT("Померај 0.1in");
  PROGMEM Language_Str MSG_SPEED                           = _UxGT("Брзина");
  PROGMEM Language_Str MSG_BED_Z                           = _UxGT("Bed Z");
  PROGMEM Language_Str MSG_NOZZLE                          = _UxGT("Дизна");
  PROGMEM Language_Str MSG_NOZZLE_N                        = _UxGT("Дизна ~");
  PROGMEM Language_Str MSG_NOZZLE_PARKED                   = _UxGT("Дизна паркирана");
  PROGMEM Language_Str MSG_NOZZLE_STANDBY                  = _UxGT("Дизна приправна");
  PROGMEM Language_Str MSG_BED                             = _UxGT("Тацна");
  PROGMEM Language_Str MSG_CHAMBER                         = _UxGT("Комора");
  ...
  PROGMEM Language_Str MSG_LASER                           = _UxGT("Ласер");
  PROGMEM Language_Str MSG_FAN_SPEED                       = _UxGT("Брзина вентилатора");
  PROGMEM Language_Str MSG_FAN_SPEED_N                     = _UxGT("Брзина вентилатора ~");
  ...
  PROGMEM Language_Str MSG_SELECT                          = _UxGT("Изабери");
  PROGMEM Language_Str MSG_SELECT_E                        = _UxGT("Изабери *");
  ...
  PROGMEM Language_Str MSG_REFRESH                         = LCD_STR_REFRESH _UxGT("Освежи");
  PROGMEM Language_Str MSG_INFO_SCREEN                     = _UxGT("Екран са информацијама");
  PROGMEM Language_Str MSG_PREPARE                         = _UxGT("Припреми");
  PROGMEM Language_Str MSG_TUNE                            = _UxGT("Подеси");
  PROGMEM Language_Str MSG_POWER_MONITOR                   = _UxGT("Power monitor");
  PROGMEM Language_Str MSG_CURRENT                         = _UxGT("Струја");
  PROGMEM Language_Str MSG_VOLTAGE                         = _UxGT("Напон");
  PROGMEM Language_Str MSG_POWER                           = _UxGT("Снага");
  PROGMEM Language_Str MSG_START_PRINT                     = _UxGT("Покрени штампу");
  ...
  PROGMEM Language_Str MSG_FILAMENTCHANGE                  = _UxGT("Промени филамент");
  PROGMEM Language_Str MSG_FILAMENTCHANGE_E                = _UxGT("Промени филамент *");
  PROGMEM Language_Str MSG_FILAMENTLOAD                    = _UxGT("Убаци филамент");
  PROGMEM Language_Str MSG_FILAMENTLOAD_E                  = _UxGT("Убаци *");
  PROGMEM Language_Str MSG_FILAMENTUNLOAD                  = _UxGT("Избаци филамент");
  PROGMEM Language_Str MSG_FILAMENTUNLOAD_E                = _UxGT("Избаци *");
  PROGMEM Language_Str MSG_FILAMENTUNLOAD_ALL              = _UxGT("Избаци све");
  PROGMEM Language_Str MSG_ATTACH_MEDIA                    = _UxGT("Закачи медиј");
  PROGMEM Language_Str MSG_CHANGE_MEDIA                    = _UxGT("Промени медиј");
  PROGMEM Language_Str MSG_RELEASE_MEDIA                   = _UxGT("Ослободи медиј");
  ...
  PROGMEM Language_Str MSG_BLTOUCH_SELFTEST                = _UxGT("Самопровера");
  ...
  PROGMEM Language_Str MSG_DELTA_HEIGHT                    = _UxGT("Висина");
  PROGMEM Language_Str MSG_DELTA_RADIUS                    = _UxGT("Radius");
  PROGMEM Language_Str MSG_INFO_MENU                       = _UxGT("О штампачу");
  PROGMEM Language_Str MSG_INFO_PRINTER_MENU               = _UxGT("Информације о штампачу");
  ...
  PROGMEM Language_Str MSG_INFO_STATS_MENU                 = _UxGT("Статистика штампача");
  PROGMEM Language_Str MSG_INFO_BOARD_MENU                 = _UxGT("Информације о плочи");
  ...
  PROGMEM Language_Str MSG_INFO_PSU                        = _UxGT("Напајање");
  PROGMEM Language_Str MSG_DRIVE_STRENGTH                  = _UxGT("Drive Strength");
  PROGMEM Language_Str MSG_DAC_PERCENT_X                   = _UxGT("X управљач %");
  PROGMEM Language_Str MSG_DAC_PERCENT_Y                   = _UxGT("Y управљач %");
  PROGMEM Language_Str MSG_DAC_PERCENT_Z                   = _UxGT("Z управљач %");
  PROGMEM Language_Str MSG_DAC_PERCENT_E                   = _UxGT("E управљач %");
  ...
  PROGMEM Language_Str MSG_FILAMENT_CHANGE_OPTION_RESUME   = _UxGT("Настави штампу");
  PROGMEM Language_Str MSG_FILAMENT_CHANGE_NOZZLE          = _UxGT("  Дизна: ");
  PROGMEM Language_Str MSG_RUNOUT_SENSOR                   = _UxGT("Сензор истека филамента");
  ...
  //
    ...
    PROGMEM Language_Str MSG_PAUSE_PRINT_PARKING           = _UxGT(MSG_1_LINE("Паркирам..."));
    ...
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_HEATING       = _UxGT(MSG_1_LINE("Загревам..."));
    ...
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_RESUME        = _UxGT(MSG_1_LINE("Настављам..."));
  #endif
  PROGMEM Language_Str MSG_TMC_DRIVERS                     = _UxGT("TMC драјвери");
  PROGMEM Language_Str MSG_TMC_CURRENT                     = _UxGT("Струја драјвера");
  ...
  PROGMEM Language_Str MSG_LEVEL_X_AXIS                    = _UxGT("Поравнај X осу");
  PROGMEM Language_Str MSG_AUTO_CALIBRATE                  = _UxGT("Калибриши аутоматски");
  ...
  PROGMEM Language_Str MSG_TOP_LEFT                        = _UxGT("Горе лево");
  PROGMEM Language_Str MSG_BOTTOM_LEFT                     = _UxGT("Доле лево");
  PROGMEM Language_Str MSG_TOP_RIGHT                       = _UxGT("Горе десно");
  PROGMEM Language_Str MSG_BOTTOM_RIGHT                    = _UxGT("Доле десно");
  PROGMEM Language_Str MSG_CALIBRATION_COMPLETED           = _UxGT("Калибрација завршена");
  PROGMEM Language_Str MSG_CALIBRATION_FAILED              = _UxGT("Калибрација није успела");
